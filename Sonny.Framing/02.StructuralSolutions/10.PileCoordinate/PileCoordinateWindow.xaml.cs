...
namespace SonnyBIM
{
    public partial class PileCoordinateWindow : Window
    {
        private PileCoordinateViewModel _viewModel;

        public PileCoordinateWindow(PileCoordinateViewModel viewModel)
        {
            InitializeComponent();
