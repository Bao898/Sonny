...
namespace SonnyBIM
{
    public class PileCoordinateProgressReporter : IProgressReporter
    {
        private PileCoordinateProgressView _progressView;

        public void Show(string title)
        {
            _progressView = new PileCoordinateProgressView(title);
            _progressView.Show();
